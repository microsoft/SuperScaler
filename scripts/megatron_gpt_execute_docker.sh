...
if [ "$exp_setting" == "small" ]; then
    echo "[ERROR] this script is specially designed for large-scale running with docker, please run 'bash scripts/megatron_gpt_execute.sh small' instead"
    ...
    echo "[ERROR] this script is specially designed for large-scale running with docker, please run 'bash scripts/megatron_gpt_execute.sh scale' instead"
