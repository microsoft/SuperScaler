...
if [ "$exp_setting" == "small" ]; then
  run_experiment 1 4 ae_small 1B
elif [ "$exp_setting" == "large" ]; then
  run_experiment 4 8 ae_large 500M
  run_experiment 2 8 ae_large 2B
  run_experiment 1 8 ae_large 4B
  run_experiment 1 4 ae_large 6_8B
  run_experiment 1 1 ae_large 13B
fi