...
def get_search_cases(model_name, max_global_batch_size, num_micro_batches_list, use_remat=use_remat):
...
ae_small_suite = {  # key = the number of gpus, value = a list of cases
    4: (get_search_cases("1B", 768, [12, 16], True) +
        get_search_cases("1B", 768, [12, 16], False))
}

ae_large_suite = {  # key = the number of gpus, value = a list of cases
    1: (get_search_cases("500M", 1536, [24, 32], True) +
        get_search_cases("500M", 1536, [24, 32], False)),
    4: (get_search_cases("2B", 1536, [24, 32], True) +
        get_search_cases("2B", 1536, [24, 32], False)),
    8: (get_search_cases("4B", 1536, [24, 32], True) +
        get_search_cases("4B", 1536, [24, 32], False)),
    16: (get_search_cases("6.8B", 1536, [24, 32], True) +
        get_search_cases("6.8B",1536, [24, 32], False)),
    32: (get_search_cases("13B", 1536, [24, 32], True) + 
        get_search_cases("13B", 1536, [24, 32], False)),
}
