...
#include "cuda_ipc/cuda_ipc_api.hpp"
#include "cuda_ipc/cuda_ipc_comm_primitive.hpp"
...
void allReduce_Ring(float *gradients, size_t size, std::string selfName, Plan plan, bool debugMode = false);
