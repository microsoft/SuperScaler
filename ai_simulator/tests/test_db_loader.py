...
class TestDBLoader():
    def setup_class(self):
        db_path = os.path.join(os.path.dirname(__file__), "test_db_loader_input/test_db.json")
        self.database = DatabaseLoader(db_type=DatabaseBackendLocalFile, db_file_path=db_path)
