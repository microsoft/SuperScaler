...
parsed DAG file. Attributes that can directly got from .pbtxt file will be
filled into .json file in this module.
...
class TFNode():
    def __init__(self, index=0,
        ...
        # In most cases, this attribute is 0. Read the first output of given
        # node.
        # self.input_data_ids = []
    ...
    def parse_protobuf_graph(self, graph_def):
        ...
        for node in node_list:
            for input_name in node.raw_inputs:
                input_idx = name_list.index(input_name) if (
                    input_name in name_list) else -1
